...
if (mediaQueryDesktop.matches) {
    ...
    const itemsUnder = document.querySelectorAll(".section-navigation__item--under");
    const navigationUnder = document.querySelector(".section-navigation--under");
    const sections = document.querySelectorAll(".section-content");
    ...
    items.forEach((item, index) => {
        item.addEventListener('mouseenter', () => {
            ...
            if (!sectionOpen) {
                mainElement.style.height = "calc(100vh - 112px)";
                mainElement.style.gridTemplateRows = "2fr 1fr 1fr";
    ...
    sections.forEach((section, index) => {
        ...
        section.addEventListener("click", function(event) {
            ...
            if (clickX >= rect.right - 64 && clickX <= rect.right && clickY >= rect.top && clickY <= rect.top + 64) {
                ...
                navigationUnder.style.display = 'none';
        ...
        items.forEach((openSection) => {
            ...
            openSection.addEventListener('click', () => {
                ...
                if (section.classList.contains('transition-section--active')) {
                    ...
                    navigationUnder.style.display = 'grid';
...
gradientAnimation.to("#a stop:first-child", {
    attr: {
        "stop-color": "#8C8CC0"
    },
    duration: 3
});
gradientAnimation.to("#a stop:last-child", {
    attr: {
        "stop-color": "#86A8E7"
    },
    duration: 2
